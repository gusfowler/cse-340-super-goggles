...
void Parser::addList(char* lexeme){
    if(symbolTable == NULL){
...
void Parser::searchList(char* iD, int lR) {// add an argument to accept a type
    bool found = false;
